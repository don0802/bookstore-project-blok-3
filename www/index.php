...
$resultGengres = mysqli_query($conn, "SELECT DISTINCT genre FROM boeken ORDER BY genre");
$genres = mysqli_fetch_all($resultGengres, MYSQLI_ASSOC);

$resultAuteurs = mysqli_query($conn, "SELECT DISTINCT auteur FROM boeken ORDER BY auteur");
$auteurs = mysqli_fetch_all($resultAuteurs, MYSQLI_ASSOC);

$query = "SELECT * FROM boeken WHERE 1=1";

if ($filterGenre != "") {
    $query = $query . " AND genre = '$filterGenre'";
}

if ($filterAuteur != "") {
    $query = $query . " AND auteur = '$filterAuteur'";
}
            ...
            <form class="filter-bar" method="get" action="">
                <div class="filter-group">
                    ...
                    <select name="genre" id="genre">
                        ...
                        <option value="<?php echo $genre['genre']; ?>"
                            <?php if ($filterGenre == $genre['genre']) { echo 'geselecteerd'; } ?>>
                ...
                <div class="filter-group">
                    ...
                    <select name="auteur" id="auteur">
                        ...
                        <option value="<?php echo $auteur['auteur']; ?>"
                            <?php if ($filterAuteur == $auteur['auteur']) { echo 'geselecteerd'; } ?>>
                ...
                <div class="filter-group">
                    ...
                    <select name="sorteer" id="sorteer">
                        ...
                        <option value="prijs_asc"  <?php if ($filterSorteer == 'prijs_asc')  { echo 'geselecteerd'; } ?>>Laag naar hoog</option>
                        <option value="prijs_desc" <?php if ($filterSorteer == 'prijs_desc') { echo 'geselecteerd'; } ?>>Hoog naar laag</option>
                    </select>
                </div>
